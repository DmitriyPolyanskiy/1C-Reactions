...
Процедура РКЦ_ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды)
	...
	Пока Реакция.Следующий() Цикл
		...
		ЗаполнитьОбщиеДанныеКоманды(КомандаРеакции);
	...
	ЗаполнитьОбщиеДанныеКоманды(КомандаУдалить);
...
Процедура ЗаполнитьОбщиеДанныеКоманды(КомандаРеакции)
	
	КомандаРеакции.ТипПараметра = РКЦ_РеакцииПовтИсп.ОписаниеТиповОбъектовСРеакциями();
